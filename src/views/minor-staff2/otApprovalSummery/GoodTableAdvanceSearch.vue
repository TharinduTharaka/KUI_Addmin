        ...
        <b-table
          ...
          <template #cell(action)="row">
            ...
            <b-button
                ...
                @click="addLeavesForMinorStaff(row.item.id, row.item.givenName)">
              Add Leave
            </b-button>
            <br>
            <br>
            <b-button
                ...
                @click="getMinorStaffLeaves(row.item.id, row.item.givenName)">
              Check Leaves
            </b-button>
          </template>
...
export default {
  ...
  methods: {
    ...
    getChildTask(user_id, user_name) {
      ...
      this.$router.push(`/apps/minor-staff-attendance`)
      return {}
    },
    getMinorStaffLeaves(user_id, user_name) {
      localStorage.setItem('child_id', JSON.stringify(user_id))
      localStorage.setItem('child_name', JSON.stringify(user_name))
      this.$router.push(`/apps/minor-staff-leaves`)
      return {}
    },
    addLeavesForMinorStaff(user_id, user_name) {
      localStorage.setItem('child_id', JSON.stringify(user_id))
      localStorage.setItem('child_name', JSON.stringify(user_name))
      this.$router.push(`/apps/minor-staff-leaves/add`)
      return {}
    },
    getStatus(val) {
      if (val === 'draft') {
