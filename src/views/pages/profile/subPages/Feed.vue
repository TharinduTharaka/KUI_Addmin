<template>
  ...
  <div>
    ...
    <b-button
        style="margin-bottom: 30px; height: 60px; width: 100%"
        variant="danger"
        @click="() => $router.push(`/apps/profile/addPost`)"
    >
      Add My Post
    </b-button>
    ...
    <b-card
        v-for="(data) in posts"
        :key="require('@/assets/images/portrait/small/avatar-s-19.jpg')"
    >
      <div
      ...
      >
        <!-- avatar -->
        <b-avatar
            :src="require('@/assets/images/portrait/small/avatar-s-19.jpg')"
            size="50"
            class="mr-1"
        />
        <!--/ avatar -->
