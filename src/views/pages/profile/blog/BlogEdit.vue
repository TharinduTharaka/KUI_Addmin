...
export default {
  ...
  methods: {
    async addPost() {
      ...
      this.post_values.title = this.blogEdit.blogTitle
      this.post_values.category = this.blogEdit.blogCategories
      this.post_values.slug = this.blogEdit.slug
      this.post_values.status = this.blogEdit.status
      this.post_values.content = this.blogEdit.excerpt
      console.log(this.post_values)
      await profileAPI.createPost(userData.id,this.post_values)
          .then((response) => {
